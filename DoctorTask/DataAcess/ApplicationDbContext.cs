    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Doctor>().HasData(
                new Doctor { Id = 1, Name = "Dr. Ahmed", Phone = "0100000001", Email = "ahmed@test.com", ImageUrl = "team-2.jpg", SpecilizationId = 1 },
                new Doctor { Id = 2, Name = "Dr. Sara", Phone = "0100000002", Email = "sara@test.com", ImageUrl = "team-1.jpg", SpecilizationId = 2 },
                new Doctor { Id = 3, Name = "Dr. Ali", Phone = "0100000003", Email = "ali@test.com", ImageUrl = "team5.jpg", SpecilizationId = 3 },
                new Doctor { Id = 4, Name = "Dr. Omar", Phone = "0100000004", Email = "omar@test.com", ImageUrl = "team-4.jpg", SpecilizationId = 4 },
                new Doctor { Id = 5, Name = "Dr. Nada", Phone = "0100000005", Email = "nada@test.com", ImageUrl = "team-3.jpg", SpecilizationId = 5 },
                new Doctor { Id = 6, Name = "Dr. Hassan", Phone = "0100000006", Email = "hassan@test.com", ImageUrl = "team6.jpg", SpecilizationId = 6 },
                new Doctor { Id = 7, Name = "Dr. Laila", Phone = "0100000007", Email = "laila@test.com", ImageUrl = "team-1.jpg", SpecilizationId = 7 },
